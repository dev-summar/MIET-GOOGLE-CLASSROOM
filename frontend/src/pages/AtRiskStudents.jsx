...
function AtRiskStudents() {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    api
      .get('/at-risk-students', { params: { page, limit, search: debouncedSearch } })
      .then((res) => {
    ...
    <div className="fade-in">
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">Missed ≥40%, 2+ consecutive missing, or submission rate &lt; 60%</p>
        </div>
          ...
          <div className="table-wrap">
            <table>
              ...
              <tbody>
                {data.length === 0 ? (
                  <tr>
                    <td colSpan={5} className="empty-state">No at-risk students found.</td>
                  </tr>
                ) : (
                  data.map((s) => (
                    <tr key={s.userId}>
